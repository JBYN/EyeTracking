...
class Face:
    ...
    def find_eye_vectors(self) -> cons.Point:
        if self.get_right_eye().get_pupil() and self.get_left_eye().get_pupil():
            ...
            y_left_norm = 50*y_left/dist_left
            ...
            x_left_norm = 50 * x_left/dist_left
            ...
            y_right_norm = 50*y_right/dist_right
            ...
            x_right_norm = 50*x_right/dist_right
            return cons.Point((x_left_norm + x_right_norm)/2, (y_left_norm + y_right_norm)/2)
        return None
